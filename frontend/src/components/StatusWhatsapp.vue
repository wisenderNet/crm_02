...
<!--
  ...
  >
    <span class="q-ml-md text-weight-medium text-center text-caption text-white ">
      Verifique el celular, la conexión se ha perdido.
    </span>
  ...
  >
    <span class="q-ml-md text-weight-medium text-center text-caption text-white ">
      Es necesario escanear el Código QR en conexiones.
    </span>
    <q-tooltip content-class="bg-light-blue-1 text-black q-pa-sm shadow-4">
      ...
      <span class="row col">
        3 - Escanee el Código QR generado con la aplicación de WhatsApp en el celular y espere a que se establezca la conexión.
      </span>
    </q-tooltip>
  </q-icon>
  <q-icon
  ...
  >
    <span class="q-ml-md text-weight-medium text-center text-caption text-white ">
      Verifique el celular y la conexión a internet, la conexión se ha perdido. Intentando reconectar con WhatsApp.
    </span>
    <q-tooltip content-class="bg-light-blue-1 text-black q-pa-sm shadow-4">
      <span class="text-weight-medium"> Acción: </span>
      <span class="row col">
