...
const routes = [
  {
    ...
    children: [
      ...
      { path: '/tarefas', name: 'tarefas', component: () => import('pages/tarefas/Index.vue') },
      { path: '/integracoes', name: 'integracoes', component: () => import('pages/integracoes/Index.vue') },
      { path: '/despedida', name: 'despedida', component: () => import('pages/despedida/Index.vue') },
      {
        path: '/chat-flow',
